...
class EoHCANNInterface(EoHInterface):
    ...
    def _get_base_task_description(self) -> str:
        """Get base task description for prompts"""
        base_task_description = self.task.get_base_task_description()
        return f"""
{base_task_description}

Your goal is to develop high-performance Ascend C kernel implementations for this operator.
"""
...
"""
    ...
    def parse_response(self, response_str: str) -> Solution:
        ...
        # Store algorithm description in the solution
